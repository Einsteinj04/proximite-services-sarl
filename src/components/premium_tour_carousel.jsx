...
// // // SVG Illustrations for Different Tour Types
// // const TourIllustrations = {
// //   beach: (
// //     <svg viewBox="0 0 400 250" className="w-full h-full">
// //       <path d="M0,150 Q200,100 400,150 L400,250 L0,250 Z" fill="#38BDF8" /> {/* Ocean */}
// //       <path d="M0,150 Q100,130 200,150 Q300,170 400,150 L400,250 L0,250 Z" fill="#0EA5E9" /> {/* Waves */}
// //       <circle cx="100" cy="80" r="40" fill="#FBBF24" /> {/* Sun */}
// //       <path d="M50,180 Q150,120 250,180 Q350,240 400,200" stroke="#F59E0B" strokeWidth="3" fill="none" /> {/* Palm tree trunk */}
// //       <path d="M250,150 Q270,100 290,150 Q310,200 330,150" stroke="#10B981" strokeWidth="3" fill="none" /> {/* Palm leaves */}
// //     </svg>
// //   ),
// //   mountain: (
// //     <svg viewBox="0 0 400 250" className="w-full h-full">
// //       <path d="M0,200 L100,50 L200,150 L300,30 L400,200 L400,250 L0,250 Z" fill="#64748B" /> {/* Mountains */}
// //       <path d="M50,180 L150,80 L250,130 L350,40" stroke="#E2E8F0" strokeWidth="3" fill="none" /> {/* Snow caps */}
// //       <circle cx="300" cy="50" r="20" fill="#F59E0B" /> {/* Sun */}
// //     </svg>
// //   ),
// //   city: (
// //     <svg viewBox="0 0 400 250" className="w-full h-full">
// //       <rect x="0" y="150" width="400" height="100" fill="#334155" /> {/* Ground */}
// //       <rect x="50" y="80" width="30" height="70" fill="#94A3B8" /> {/* Buildings */}
// //       <rect x="100" y="50" width="40" height="100" fill="#64748B" />
// //       <rect x="160" y="30" width="50" height="120" fill="#475569" />
// //       <rect x="230" y="70" width="35" height="80" fill="#64748B" />
// //       <rect x="290" y="40" width="45" height="110" fill="#475569" />
// //       <circle cx="350" cy="30" r="15" fill="#F59E0B" /> {/* Sun */}
// //     </svg>
// //   )
// // };
...
// //       <button 
// //         onClick={scrollLeft}
// //         className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 hover:bg-white text-gray-800 p-3 rounded-full shadow-xl backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300"
// //       >
...
// //       <button 
// //         onClick={scrollRight}
// //         className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 hover:bg-white text-gray-800 p-3 rounded-full shadow-xl backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300"
// //       >
...
// //       <div 
// //         ref={carouselRef}
// //         className="flex overflow-x-auto pb-8 hide-scrollbar scroll-smooth space-x-6 px-2 border-red-500"
// //       >
// //         {tours.map((tour) => (
// //           <motion.div
// //             key={tour.id}
...
// //             viewport={{ once: true }}
// //             transition={{ duration: 0.5 }}
// //             className="flex-shrink-0 w-80 h-[420px] rounded-2xl overflow-hidden shadow-xl relative bg-gradient-to-br from-blue-500 to-indigo-600"
// //           >
// //             {/* Dynamic SVG Background */}
...
// //                   <FiStar className="mr-1" /> Best Seller
// //                 </span>
// //               )}
// //               {tour.discount && (
...
// //                     <span className="text-2xl font-bold mr-2">${tour.price}</span>
// //                     {tour.originalPrice && (
// //                       <span className="text-sm text-white/70 line-through">${tour.originalPrice}</span>
// //                     )}
// //                   </div>
// //                   <span className="text-xs text-white/70">per person</span>
// //                 </div>
                
// //                 <button className="bg-white hover:bg-gray-100 text-gray-900 font-medium py-2 px-4 rounded-lg transition-all transform hover:scale-105">
// //                   Explore
// //                 </button>
// //               </div>
// //             </div>
